...
📚 [**Begin with the Hello Bot**](/learn/tutorials/hello-bot): learn how to deploy your own bot and interact with it.

📚 [**Send an interaction response**](/learn/guides/reply-on-command): learn how to respond to an interaction received by your bot.

📚 [**Discord API types**](/learn/api-types/types): get to know the decisions we made about the Discord API types.
